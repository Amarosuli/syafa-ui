<script>
	...
	function prepareImageData() {
		...
		[ctx.drawing.canvas].forEach(function (n) {
			_ctx.beginPath();
...
<div class="drawing-container bg-white {classes}" style="height:{canvasHeight}px; width:{canvasWidth}px; " bind:this={canvasContainer}>
